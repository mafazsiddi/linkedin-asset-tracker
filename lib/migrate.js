...
const STATEMENTS = [
  ...
  // "Have we fetched this window yet" can't be answered by looking for cached rows, because
  // "LinkedIn reported nothing" is a legitimate and common answer — demographic values below a
  // privacy threshold are dropped entirely. Keying freshness off row presence meant every empty
  // window re-hit LinkedIn on every open, and the panel's widen-to-90-days retry made that twice.
