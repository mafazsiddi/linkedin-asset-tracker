...
// Metrics live on the campaign, not the asset (several assets can share one campaign, and
// LinkedIn only reports at campaign granularity) — so every asset on a shared campaign shows
// that campaign's current-month rollup here.
const ASSET_SELECT = `
  select a.*,
